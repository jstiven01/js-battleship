...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scss/style.scss */ \"./src/scss/style.scss\");\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_style_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _js_gameBoard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/gameBoard */ \"./src/js/gameBoard.js\");\n/* harmony import */ var _js_player__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/player */ \"./src/js/player.js\");\n/* harmony import */ var _js_ship__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/ship */ \"./src/js/ship.js\");\n/* harmony import */ var _js_ui__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/ui */ \"./src/js/ui.js\");\n\n\n\n\n\nvar arrayShipsH = [Object(_js_ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(2)];\nvar arrayShipsC = [Object(_js_ship__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(2)]; // const arrayShipsC = [Ship(5), Ship(4), Ship(3), Ship(3), Ship(2)];\n\nvar gameBoardH = Object(_js_gameBoard__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\nvar gameBoardC = Object(_js_gameBoard__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\nvar playerComputer = Object(_js_player__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('Player Computer', 'C', arrayShipsC);\nvar playerHuman = Object(_js_player__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('Player Human', 'H', arrayShipsH);\nplayerHuman.setTurn(true);\nplayerComputer.setTurn(false);\nplayerHuman.setShips(gameBoardH);\nplayerComputer.setShips(gameBoardC);\n_js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderInitialBoards(playerHuman, gameBoardH);\n_js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderInitialBoards(playerComputer, gameBoardC);\nvar buttons = document.querySelectorAll('.button-position-player2');\nconsole.log(gameBoardC.getBoard());\nvar eventComputer = new Event('EventComputer');\nvar sectionPlayer1 = document.getElementById('section-player-1');\n\nvar playHuman = function playHuman(event) {\n  if (!gameBoardC.isOver() && playerHuman.getTurn() && !gameBoardH.isOver()) {\n    var row = parseInt(event.target.dataset.row, 10);\n    var column = parseInt(event.target.dataset.column, 10);\n    playerHuman.attackRival(gameBoardC, {\n      row: row,\n      column: column\n    });\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderAttack(playerComputer, gameBoardC, {\n      row: row,\n      column: column\n    }, event);\n\n    if (gameBoardC.getHit()) {\n      playerHuman.setTurn(true);\n      playerComputer.setTurn(false);\n      _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerHuman);\n    } else {\n      playerHuman.setTurn(false);\n      playerComputer.setTurn(true);\n      _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].disablePlayer();\n      _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerComputer);\n      sectionPlayer1.dispatchEvent(eventComputer);\n    }\n  } else if (gameBoardC.isOver()) {\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerHuman, gameBoardC);\n  } else if (gameBoardH.isOver()) {\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playComputer, gameBoardH);\n  }\n};\n\nvar playComputer = function playComputer(event) {\n  console.log('this is PC', event);\n\n  if (!gameBoardC.isOver() && playerComputer.getTurn() && !gameBoardH.isOver()) {\n    playerComputer.attackRival(gameBoardH);\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderAttack(playerHuman, gameBoardH);\n\n    if (gameBoardH.getHit()) {\n      playerHuman.setTurn(false);\n      playerComputer.setTurn(true);\n      _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerComputer);\n      setTimeout(function () {\n        sectionPlayer1.dispatchEvent(eventComputer);\n      }, 2000);\n    } else {\n      setTimeout(_js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].disablePlayer, 2000);\n      playerHuman.setTurn(true);\n      playerComputer.setTurn(false);\n      _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerHuman);\n    }\n  } else if (gameBoardC.isOver()) {\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playerHuman, gameBoardC);\n  } else if (gameBoardH.isOver()) {\n    _js_ui__WEBPACK_IMPORTED_MODULE_4__[\"default\"].renderMessage(playComputer, gameBoardH);\n  }\n};\n\nbuttons.forEach(function (button) {\n  return button.addEventListener('click', playHuman);\n});\nsectionPlayer1.addEventListener('EventComputer', playComputer);\n\n//# sourceURL=webpack:///./src/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _nonIterableSpread(); }\n\nfunction _nonIterableSpread() { throw new TypeError(\"Invalid attempt to spread non-iterable instance\"); }\n\nfunction _iterableToArray(iter) { if (Symbol.iterator in Object(iter) || Object.prototype.toString.call(iter) === \"[object Arguments]\") return Array.from(iter); }\n\nfunction _arrayWithoutHoles(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = new Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } }\n\nvar gameBoard = function gameBoard() {\n  var board = _toConsumableArray(Array(10)).map(function () {\n    return Array(10).fill(null);\n  });\n\n  var shipsPositions = [];\n  var isAHit;\n\n  var renderShipOnBoard = function renderShipOnBoard(ship, position, orientation) {\n    if (orientation === 'V') {\n      for (var i = position.row; i < position.row + ship.length; i += 1) {\n        board[i][position.column] = ship.getType();\n      }\n    } else {\n      for (var _i = position.column; _i < position.column + ship.length; _i += 1) {\n        board[position.row][_i] = ship.getType();\n      }\n    }\n  };\n\n  var validatePosition = function validatePosition(ship, position, orientation) {\n    for (var i = 0; i < shipsPositions.length; i += 1) {\n      var initialRow = shipsPositions[i].position.row;\n      var initialCol = shipsPositions[i].position.column;\n      var finalRow = shipsPositions[i].position.row + shipsPositions[i].ship.length - 1;\n      var finalColumn = shipsPositions[i].position.column + shipsPositions[i].ship.length - 1;\n\n      if (shipsPositions[i].orientation === 'V' && orientation === 'V' && (position.row + ship.length - 1 >= initialRow && position.row + ship.length - 1 <= finalRow || position.row >= initialRow && position.row <= finalRow) && initialCol === position.column) {\n        return false;\n      }\n\n      if (shipsPositions[i].orientation === 'H' && orientation === 'V' && position.row <= initialRow && position.row + ship.length - 1 >= initialRow && initialCol <= position.column && position.column <= finalColumn) {\n        return false;\n      }\n\n      if (shipsPositions[i].orientation === 'V' && orientation === 'H' && position.column <= initialCol && position.column + ship.length - 1 >= initialCol && initialRow <= position.row && position.row <= finalRow) {\n        return false;\n      }\n\n      if (shipsPositions[i].orientation === 'H' && orientation === 'H' && (position.column + ship.length - 1 >= initialCol && position.column + ship.length - 1 <= finalColumn || position.column >= initialCol && position.column <= finalColumn) && initialRow === position.row) {\n        return false;\n      }\n    }\n\n    return true;\n  };\n\n  var placeShip = function placeShip(ship, position, orientation) {\n    if (!validatePosition(ship, position, orientation)) return false;\n    shipsPositions.push({\n      ship: ship,\n      position: position,\n      orientation: orientation\n    });\n    renderShipOnBoard(ship, position, orientation);\n    return true;\n  };\n\n  var isHitShip = function isHitShip(position) {\n    for (var i = 0; i < shipsPositions.length; i += 1) {\n      var initialCol = shipsPositions[i].position.column;\n      var initialRow = shipsPositions[i].position.row;\n\n      if (shipsPositions[i].orientation === 'V' && initialCol === position.column && position.row - initialRow >= 0 && position.row - initialRow <= shipsPositions[i].ship.length - 1) {\n        shipsPositions[i].ship.hit(position.row - initialRow);\n        if (shipsPositions[i].ship.isSunk()) shipsPositions.splice(i, 1);\n        return true;\n      }\n\n      if (shipsPositions[i].orientation === 'H' && initialRow === position.row && position.column - initialCol >= 0 && position.column - initialCol <= shipsPositions[i].ship.length - 1) {\n        shipsPositions[i].ship.hit(position.column - initialCol);\n        if (shipsPositions[i].ship.isSunk()) shipsPositions.splice(i, 1);\n        return true;\n      }\n    }\n\n    return false;\n  };\n\n  var getHit = function getHit() {\n    return isAHit;\n  };\n\n  var isOver = function isOver() {\n    return shipsPositions.length === 0;\n  };\n\n  var saveAttack = function saveAttack(position) {\n    if (isAHit) {\n      board[position.row][position.column] = 'X';\n    } else {\n      board[position.row][position.column] = 'M';\n    }\n  };\n\n  var receiveAttack = function receiveAttack(position) {\n    isAHit = isHitShip(position);\n    saveAttack(position);\n  };\n\n  var getBoard = function getBoard() {\n    return board;\n  };\n\n  return {\n    placeShip: placeShip,\n    receiveAttack: receiveAttack,\n    getHit: getHit,\n    isOver: isOver,\n    getBoard: getBoard\n  };\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (gameBoard);\n\n//# sourceURL=webpack:///./src/js/gameBoard.js?");
